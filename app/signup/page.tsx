  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[80vh] px-4 animate-fade-in">
      ...
      <div className="text-center mb-8">
        <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-green-500/10 border border-green-500/20 mb-4 shadow-[0_0_30px_rgba(34,197,94,0.2)]">
          <span className="text-3xl">✨</span>
        </div>
        <h1 className="text-3xl font-black text-white tracking-tight mb-2">Create Account</h1>
        <p className="text-gray-400">Start automating your job hunt today</p>
      </div>
      ...
      <div className="w-full max-w-md glass bg-[#0f172a]/90 backdrop-blur-xl border border-white/10 rounded-2xl p-8 sm:p-10 shadow-2xl relative overflow-hidden">
        ...
        <form onSubmit={signup} className="space-y-5 relative z-10">
          ...
          <div className="space-y-1.5">
            ...
            <input
              ...
              className="w-full p-3.5 bg-black/40 border border-white/10 text-white rounded-xl focus:outline-none focus:border-green-500/50 focus:ring-1 focus:ring-green-500/50 transition-all placeholder-gray-600"
          ...
          <button 
            type="submit" 
            disabled={loading}
            className="w-full py-3.5 bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-400 hover:to-emerald-500 text-white rounded-xl font-bold shadow-[0_0_15px_rgba(16,185,129,0.3)] hover:shadow-[0_0_25px_rgba(16,185,129,0.5)] transition-all disabled:opacity-50 disabled:cursor-not-allowed flex justify-center items-center gap-2 mt-2"
          >
            {loading ? (
